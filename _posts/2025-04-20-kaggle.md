...
# _Project Title: ⚡Watt-Saver – The Personalized Energy Coach_
...
## Preparing LongGraoh nodes: We are using LongGraph's `@tool` decorator to execute the functions we define 
```python
